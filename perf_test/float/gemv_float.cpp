...
int main(int argc, char *argv[]) {
    ...
    ChipSum::Common::Init(argc, argv);
    {
        ...
        for (int i=0; i<150; i++){
            ...
            float *A1 = static_cast<float *>(std::malloc(M*N * sizeof(float)));
            ...
            float *A2 = static_cast<float *>(std::malloc(N * sizeof(float)));
            ...
            float *A3 = static_cast<float *>(std::malloc(M * sizeof(float)));
